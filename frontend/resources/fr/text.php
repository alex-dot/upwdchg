...
$_TEXT['error:invalid_credentials'] = 'Codes d\'accès erronés (nom d\'utilisateur ou ancien mot de passe).';
$_TEXT['error:invalid_password_nonce'] = 'Code PIN erroné.';
...
$_TEXT['error:password_charset_forbidden'] = 'Le mot de passe ne doit PAS contenir de caractère interdit.';
...
$_TEXT['info:password_charset_forbidden'] = 'Le mot de passe ne doit PAS contenir les caractères interdits suivants: '.str_replace(' ', '(espace)', $this->amCONFIG['password_charset_forbidden']);
